...
try:
    ...
    from asciidoc_dita_toolkit.asciidoc_dita.plugins.DirectoryConfig import DirectoryConfigModule
    ...
    # Test ContentType
    print("\nTesting ContentType...")
    from asciidoc_dita_toolkit.asciidoc_dita.plugins.ContentType import ContentTypeModule
