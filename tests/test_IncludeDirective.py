"""
Test suite for the IncludeDirective plugin.

This script tests the transformation logic using fixtures from
tests/fixtures/IncludeDirective/.
...
from asciidoc_dita_toolkit.asciidoc_dita.plugins.IncludeDirective import transform_line, process_file
from tests.asciidoc_testkit import run_linewise_test, get_same_dir_fixture_pairs, run_file_based_test

FIXTURE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), 'fixtures', 'IncludeDirective'))
