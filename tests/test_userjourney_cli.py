...
def create_test_workflow():
    ...
    (test_docs / "test.adoc").write_text(
        """= Test Document
:doctype: article
...
"""
    ...
    try:
        ...
        print(
            f"✅ Debug - First module: {resolutions[0].name if resolutions else 'None'}"
        )
        ...
        print(
            f"✅ Workflow progress: {progress.completed_modules}/{progress.total_modules} modules"
        )
