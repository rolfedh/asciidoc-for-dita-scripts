...
from asciidoc_dita_toolkit.asciidoc_dita.plugins.ExampleBlock import ExampleBlockProcessor, ExampleBlockDetector
import pathlib
...
def demo_plugin():
    ...
    # Test files
    test_files = [
        ('tests/fixtures/ExampleBlock/report_example_in_section.adoc', 'Example in Section'),
