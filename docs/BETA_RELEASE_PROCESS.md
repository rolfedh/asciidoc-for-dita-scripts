...
version = "0.1.9b1b1"  # Format: MAJOR.MINOR.PATCHbN (where N is beta number)
```

**Version Naming Convention:**
- `0.1.9b1b1` - First beta of version 0.1.9b1
- `0.1.9b1b2` - Second beta if fixes are needed
- `0.1.9b1` - Final release version
...
pip install --index-url https://test.pypi.org/simple/ asciidoc-dita-toolkit==0.1.9b1b1
```
...
# Verify availability
pip install asciidoc-dita-toolkit==0.1.9b1b1
```
...
git tag v0.1.9b1b1
git push origin v0.1.9b1b1
```

Then on GitHub:
1. Go to **Releases** → **Create a new release**
2. Choose tag: `v0.1.9b1b1`
3. Target: `feature/your-feature-name` branch
4. Title: `v0.1.9b1b1 - [Feature Name] Beta`
...
# Edit pyproject.toml: version = "0.1.9b1b2"
...
# Edit pyproject.toml: version = "0.1.9b1"

# Final commit
git commit -m "release: Finalize v0.1.9b1
...
### Beta Phase Workflow:
1. ✅ **Feature branch** + beta version (v0.1.9b1b1)
...
6. 🔄 **Iterate if needed** (v0.1.9b1b2, etc.)

### Final Release Workflow:
7. ✅ **Address feedback** on feature branch
8. ✅ **Update to final version** (v0.1.9b1)
